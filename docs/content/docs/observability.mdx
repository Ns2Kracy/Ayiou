...
```rust
use ayiou::OneBotV11Bot;
use ayiou::core::observability::{InMemoryMetrics, spawn_metrics_log_reporter};
...
async fn main() {
    ...
    // 以 OneBot 为例
    // let bot = OneBotV11Bot::ws("ws://127.0.0.1:8080").with_metrics_sink(metrics);
    // ...
}
```
